...
TECHNIQUE_NOTES: dict[str, dict[str, str]] = {
    ...
    "icp": {
        "annex_table": "Table 4 (elemental impurities by ICP-OES or ICP-MS)",
    ...
    "dissolution": {
        "annex_table": "Table 5 (dissolution with HPLC as product performance test)",
    ...
    "qnmr": {
        "annex_table": "Table 6 (quantitative 1H-NMR for assay of a drug substance)",
    ...
    "bioassay": {
        "annex_table": "Table 7 (biological assays)",
    ...
    "qpcr": {
        "annex_table": "Table 8 (quantitative PCR)",
    ...
    "particle-size": {
        "annex_table": "Table 9 (particle size measurement)",
    ...
    "nir": {
        "annex_table": "Table 10 (NIR analytical procedure)",
    ...
    "lcms": {
        "annex_table": "Table 11 (quantitative LC/MS)",
