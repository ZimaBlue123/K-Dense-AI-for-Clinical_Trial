...
results = client.search_patents({"_text_all": {"patent_abstract": "machine learning"}})
...
def monitor_portfolio(serial_numbers, api_key):
    ...
    results = {"active": [], "pending": [], "problems": []}
...
def comprehensive_patent_analysis(patent_number, api_key):
    ...
    print(
        f"  Rejections: {results['prosecution']['non_final_rejections']} non-final, {results['prosecution']['final_rejections']} final"
    )
