...
class DrugBankHelper:
    ...
    def _get_text_safe(self, element) -> str | None:
    ...
    def check_interaction(self, drug1_id: str, drug2_id: str) -> dict[str, str] | None:
        """
    ...
    def get_smiles(self, drugbank_id: str) -> str | None:
        """
    ...
    def get_inchi(self, drugbank_id: str) -> str | None:
        """
