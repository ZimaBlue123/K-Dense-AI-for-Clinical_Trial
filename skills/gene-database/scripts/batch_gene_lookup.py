...
def batch_esearch(
    queries: list[str], organism: str | None = None, api_key: str | None = None
) -> dict[str, str]:
    """
...
def batch_esummary(
    gene_ids: list[str], api_key: str | None = None, chunk_size: int = 200
...
def batch_lookup_by_symbols(
    gene_symbols: list[str], organism: str, api_key: str | None = None
) -> list[dict[str, Any]]:
    """
