...
# Radial velocity
c = SkyCoord(ra=10 * u.degree, dec=41 * u.degree, radial_velocity=20 * u.km / u.s)
...
c = SkyCoord(x=1 * u.kpc, y=2 * u.kpc, z=3 * u.kpc, representation_type="cartesian", frame="icrs")
